                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">المنطقة</th>
                            <th class="min-w-125px">مفعل</th>
                            <th class="min-w-125px">اطار المدينة</th>
        ...
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'Polygon', name: 'Polygon', "searchable": false, "orderable": true},
