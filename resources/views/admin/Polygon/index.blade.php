...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-500">قائمة اطار المنطقة</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">خط الطول</th>
                            <th class="min-w-125px">خط العرض</th>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('Polygon.datatable.data') }}',
                    data: {
                ...
                columns: [
                    ...
                    {data: 'lat', name: 'lat', "searchable": true, "orderable": true},
                    {data: 'lng', name: 'lng', "searchable": true, "orderable": true},
            ...
            $.ajax({
                url: "{{ URL::to('/add-button-Polygon/'.$id)}}",
