...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-500">قائمة انواع الخدمات</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">الوصف باللغة العربية </th>
                            <th class="min-w-125px">الوصف باللغة الانجليزية </th>
                            <th class="min-w-125px">اسعار الخدمة </th>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('ServiceType.datatable.data') }}',
                    data: {
                ...
                columns: [
                    ...
                    {data: 'ar_description', name: 'ar_description', "searchable": true, "orderable": true},
                    {data: 'en_description', name: 'en_description', "searchable": true, "orderable": true},
                    {data: 'serviceTypes', name: 'serviceTypes', "searchable": true, "orderable": true},
                    {data: 'actions', name: 'actions', "searchable": false, "orderable": false},

                ]
            });
            $.ajax({
                url: "{{ URL::to('/add-button-ServiceType/'.$id)}}",
