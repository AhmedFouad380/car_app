...
<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
    ...
    <div class="container-xxl sabi d-flex flex-grow-1 flex-stack">
        ...
        <div class="d-flex align-items-center me-5">
            ...
            <!--begin::Logo-->
            <a href="{{ url('/') }}">
                <img alt="Logo" src="{{asset('admin/assets/media/logos/logo-dark.png')}}" class="h-25px h-lg-60px"/>
            </a>
            <!--end::Logo-->
            ...
            <div class="topbar d-flex align-items-stretch flex-shrink-0" id="kt_topbar">
                ...
                <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                        ...
                        <img src="{{asset('admin/assets/media/avatars/150-26.jpg')}}" alt="{{Auth::guard('admin')->user()->name}}"/>
                    </div>
                    <!--begin::Menu-->
                    <div
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div
                                        class="fw-bolder d-flex align-items-center fs-5">{{Auth::guard('admin')->user() ? Auth::guard('admin')->user()->name : ""}}
                                        <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Pro</span>
                                    </div>
                                    <a href="#"
                                       class="fw-bold text-muted text-hover-primary fs-7">{{Auth::guard('admin')->user() ? Auth::guard('admin')->user()->phone : ""}}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
        ...
        <div class="header-menu container-xxl sabi flex-column align-items-stretch flex-lg-row" data-kt-drawer="true"
            ...
            <div
                ...
                <div
                    ...
                    <a class="menu-link py-3" href="{{url('Clients')}}">
                        <span class="menu-title">العملاء </span>
                        <span class="menu-arrow d-lg-none"></span>
                    </a>
                </div>
                <div
                    class="menu-item   @if(Request::segment(1) == 'Drivers') here show @endif menu-lg-down-accordion me-lg-1">
                    <a class="menu-link py-3" href="{{url('Drivers')}}">
                ...
                <div
                    ...
                    <a class="menu-link py-3" href="{{url('/projects')}}">
                        <span class="menu-title">قائمة الرحلات</span>
                        <span class="menu-arrow d-lg-none"></span>
                    </a>
                </div>
                ...
                <div
                    ...
                    <a class="menu-link py-3" href="{{url('Requests')}}">
                        <span class="menu-title">سجل الطلبات </span>
                        <span class="menu-arrow d-lg-none"></span>
                    </a>
                </div>
                ...
                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                    ...
                    <span
                        ...
                        Request::segment(1) == "Country-edit" ||
                         Request::segment(1) == "Countries" ||
                         Request::segment(1) == "edit-permission"||
                          Request::segment(1) == "Cities" ||
                         Request::segment(1) == "City-edit" ||
                     Request::segment(1) == "Services" ||Request::segment(1) == "edit-Service"  ||Request::segment(1) == "edit-ServiceType"  ||Request::segment(1) == "ServiceTypes"
                                              ) active @endif py-3">
                    ...
                    <div
                        ...
                        <div data-kt-menu-placement="right-start"
                            ...
                            <span
                                class="menu-link @if(Request::segment(1) == "Countries" ||Request::segment(1) == "edit-Country" ||Request::segment(1) == "edit-City" ||Request::segment(1) == "Cities") active @endif py-3">
                                <span class="menu-icon ">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <span
                                    class="menu-title  @if(Request::segment(1) == "Countries" ||Request::segment(1) == "edit-Country") text-active-primary active @endif ">
                        ...
                        <div data-kt-menu-placement="right-start"
                            ...
                            <a href="{{url('Services')}}">
                            <span
                                class="menu-link @if(Request::segment(1) == "Services" ||Request::segment(1) == "edit-Service"  ||Request::segment(1) == "edit-ServiceType"  ||Request::segment(1) == "ServiceTypes") active @endif py-3">
                                <span class="menu-icon ">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <span
                                    class="menu-title  @if(Request::segment(1) == "Services" ||Request::segment(1) == "edit-Service"  ||Request::segment(1) == "edit-ServiceType"  ||Request::segment(1) == "ServiceTypes") text-active-primary active @endif ">
